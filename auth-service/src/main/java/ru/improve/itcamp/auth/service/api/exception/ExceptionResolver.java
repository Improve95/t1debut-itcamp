...
import static ru.improve.itcamp.auth.service.api.exception.ErrorCode.ACCESS_DENIED;
...
import static ru.improve.itcamp.auth.service.api.exception.ErrorCode.ILLEGAL_DTO_VALUE;
import static ru.improve.itcamp.auth.service.api.exception.ErrorCode.ILLEGAL_VALUE;
...
import static ru.improve.itcamp.auth.service.util.MessageKeys.TITLE_ACCESS_DENIED;
import static ru.improve.itcamp.auth.service.util.MessageKeys.TITLE_ALREADY_EXIST;
import static ru.improve.itcamp.auth.service.util.MessageKeys.TITLE_EXPIRED;
import static ru.improve.itcamp.auth.service.util.MessageKeys.TITLE_ILLEGAL_DTO_VALUE;
import static ru.improve.itcamp.auth.service.util.MessageKeys.TITLE_ILLEGAL_VALUE;
import static ru.improve.itcamp.auth.service.util.MessageKeys.TITLE_INTERNAL_SERVER_ERROR;
import static ru.improve.itcamp.auth.service.util.MessageKeys.TITLE_NOT_FOUND;
...
public class ExceptionResolver {
    ...
    private ErrorCodeMessagePair resolveException(Exception ex) {
        ...
        return ErrorCodeMessagePair.of(
                ...
                resolveMessage(messageKeyMap.get(INTERNAL_SERVER_ERROR), (String) null)
        );
    }
