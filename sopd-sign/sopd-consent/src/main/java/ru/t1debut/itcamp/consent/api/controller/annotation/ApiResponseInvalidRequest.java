...
import static ru.t1debut.itcamp.consent.util.MessageKeys.API_RESPONSE_INVALID_REQUEST;

@ApiResponse(
        responseCode = API_BAD_REQUEST,
        description = API_RESPONSE_INVALID_REQUEST,
        content = {
                @Content(
...
public @interface ApiResponseInvalidRequest {
}
