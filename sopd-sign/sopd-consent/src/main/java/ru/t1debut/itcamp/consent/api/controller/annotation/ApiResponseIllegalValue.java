...
import static ru.t1debut.itcamp.consent.util.MessageKeys.API_RESPONSE_ILLEGAL_VALUE;

@ApiResponse(
        responseCode = API_BAD_REQUEST,
        description = API_RESPONSE_ILLEGAL_VALUE,
        content = {
                @Content(
...
public @interface ApiResponseIllegalValue {
}
